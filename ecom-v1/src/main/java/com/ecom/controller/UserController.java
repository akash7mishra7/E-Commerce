...
public class UserController {
    ...
    public String updateCartQuantity(@RequestParam String sy, 
                                     ...
                                     Principal p) {
        UserDtls user = getLoggedInUserDetails(p);
        cartService.updateQuantity(sy, cid, user.getId());
    ...
    public String updateProfile(@ModelAttribute UserDtls user, @RequestParam MultipartFile img, HttpSession session, Principal p) {
        UserDtls loggedInUser = getLoggedInUserDetails(p);
        // enforce update on logged-in user
    ...
    public String changePassword(@RequestParam String newPassword, 
        ...
        UserDtls updated = userService.updateUser(user);
        if (updated == null) {
